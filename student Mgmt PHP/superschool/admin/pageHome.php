		...
		<!--<div class="col-md-4" id="twitter-feed">
			<h3>
				...
				<span class="pull-right">
					<a class="twitter-follow-button" href="https://twitter.com" data-show-count="false" data-lang="en"><?php echo $Translation["follow BigProf"]; ?></a>
			...
			<div class="text-center">
				<a class="twitter-timeline" height="400" href="https://twitter.com" data-widget-id="552758720300843008" data-chrome="nofooter noheader"><?php echo $Translation["loading bigprof feed"]; ?></a>
